...
public class AddRmspropWindow implements Window {
    ...
    private AddRmspropWindowController controller;

    @Getter
    private SharedState sharedState;


    public AddRmspropWindow(SharedState sharedState) throws IOException {
        this.sharedState = sharedState;
        String nameOfModel = "/fxmls/optimizers/rmspropWindow.fxml";
