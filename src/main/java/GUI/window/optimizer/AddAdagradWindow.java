...
import GUI.window.layer.AddActivationLayerWindowController;
...
public class AddAdagradWindow implements Window {
    ...
    private AddAdagradWindowController controller;

    @Getter
    private SharedState sharedState;


    public AddAdagradWindow(SharedState sharedState) throws IOException {
        this.sharedState = sharedState;
        String nameOfModel = "/fxmls/optimizers/adagradWindow.fxml";
