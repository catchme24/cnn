...
public class AddDropoutLayerWindow implements Window {
    ...
    private AddDropoutLayerWindowController controller;

    @Getter
    private SharedState sharedState;

    public AddDropoutLayerWindow(SharedState sharedState) throws IOException {
        this.sharedState = sharedState;
        String nameOfModel = "/fxmls/dropoutLayerWindow.fxml";
