...
public class AddConvolutionLayerWindow implements Window {
    ...
    private AddConvolutionLayerWindowController controller;

    @Getter
    private SharedState sharedState;

    public AddConvolutionLayerWindow(SharedState sharedState) throws IOException {
        this.sharedState = sharedState;
        String nameOfModel = "/fxmls/convolutionLayerWindow.fxml";
