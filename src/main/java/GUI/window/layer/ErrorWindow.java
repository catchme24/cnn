...
public class ErrorWindow implements Window {
    ...
    private ErrorWindowController controller;

    @Getter
    private SharedState sharedState;


    public ErrorWindow(SharedState sharedState) throws IOException {
        this.sharedState = sharedState;
        String nameOfModel = "/fxmls/errorWindow.fxml";
    ...
    public void display(Stage owner) {
        ...
        currentWindow.setTitle("Ошибка ввода");
