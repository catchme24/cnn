...
public class AddFullyConnectedLayerWindow implements Window {
    ...
    private AddFullyConnectedLayerWindowController controller;

    @Getter
    private SharedState sharedState;

    public AddFullyConnectedLayerWindow(SharedState sharedState) throws IOException {
        this.sharedState = sharedState;
        String nameOfModel = "/fxmls/fullyConnectedLayerWindow.fxml";
