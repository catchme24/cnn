...
public class AddPoolingLayerWindow implements Window {
    ...
    private AddPoolingLayerWindowController controller;

    @Getter
    private SharedState sharedState;

    public AddPoolingLayerWindow(SharedState sharedState) throws IOException {
        this.sharedState = sharedState;
        String nameOfModel = "/fxmls/poolingLayerWindow.fxml";
